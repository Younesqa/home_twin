  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="mb-6">
          <div className="flex justify-between mb-2 text-sm"><span className="text-white/50">{t(`الخطوة ${step} من 6`, `Step ${step} of 6`)}</span><span className="text-cyan-400">{Math.round((step/6)*100)}%</span></div>
          <div className="h-1.5 bg-white/8 rounded-full overflow-hidden"><motion.div className="h-full bg-cyan-400" animate={{ width: `${(step/6)*100}%` }} /></div>
        </div>
